            ...
            <div class="flex justify-between items-center h-20 gap-4 sm:gap-8">
                ...
                <div class="flex items-center gap-2 cursor-pointer shrink-0" onclick="window.location.href='{{ route('home') }}'">
                    ...
                    <div class="flex flex-col">
                        <span class="text-[#1e3a8a] font-extrabold text-2xl tracking-tight leading-none mb-0.5">SISPEK</span>
                        <span class="text-gray-900 text-[10px] font-bold tracking-[0.2em] uppercase leading-none">Tasikmalaya</span>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                ...
                <div class="col-span-1 md:col-span-1">
                    <div class="flex items-center gap-2 mb-6 cursor-pointer">
                        <div class="text-[#1e3a8a] font-bold text-xl leading-none uppercase">SISPEK</div>
                    </div>
