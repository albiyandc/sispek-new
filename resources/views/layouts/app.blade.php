    ...
    <header class="sticky top-0 sm:top-3 z-50 px-2 sm:px-4 transition-all duration-300">
        <nav class="max-w-7xl mx-auto rounded-2xl sm:rounded-full px-3 sm:px-6 py-2.5 transition-all duration-300" 
            ...
            <div class="flex justify-between items-center gap-2 sm:gap-6">
                ...
                <!-- Search Bar (Desktop & Mobile Bar) -->
                <form action="{{ route('layanan.semua') }}" method="GET" class="flex flex-1 max-w-[170px] xs:max-w-[220px] sm:max-w-xs md:max-w-md lg:max-w-lg px-1 sm:px-2">
                    <div class="relative w-full group">
                        ...
                        <input type="text" name="q" placeholder="Cari info..." 
                               class="w-full pl-8 sm:pl-11 pr-3 sm:pr-10 py-1.5 sm:py-2.5 rounded-full text-xs sm:text-sm font-medium focus:outline-none focus:ring-4 transition-all"
