...
<div class="bg-[#F8FAFC] min-h-screen pb-20 pt-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-up">
        ...
        <div class="bg-gradient-to-r from-slate-900 via-blue-950 to-slate-900 text-white -mx-4 sm:mx-0 -mt-8 sm:-mt-12 pt-20 sm:pt-24 rounded-none sm:rounded-3xl p-6 sm:p-12 mb-8 shadow-xl relative overflow-hidden">
